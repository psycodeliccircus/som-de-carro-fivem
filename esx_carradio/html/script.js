$('#shutdownbutton').click(function() {
    $.post('https://esx_carradio/action', JSON.stringify({
        action: 'exit'
    }));
})
...
function getNameFile(url) {
	if (url == undefined) {
		vidname = "Nenhuma coisa";
		document.getElementById("testrec").innerHTML = "<b>Toncando:</b><marquee direction = 'right'> "+ vidname + "</marquee>"
	} else {
